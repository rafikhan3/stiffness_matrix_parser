...
PART_NAME     = 'Part-1'     # name of the 3D solid part to partition
HOLE_RADIUS   = 0.16         # radius of the through-holes to look for
WASHER_RADIUS = 0.20         # OUTER radius of the washer ring
...
N_RADIAL          = 2       # elements ACROSS the washer gap (r=2 -> r=3)
